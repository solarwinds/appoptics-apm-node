...
module.exports = {
  //
  // Appoptics APM can be disabled by setting enabled to false.
  //
  enabled: true,
  //
  // Determines when to sample for incoming requests. This can be set
  // at any time to change behaviour while the process is running.
  //
  // Available settings:
  // - always - This enables sampling at the system-determined rate.
  // - never - When you don't want any sampling to occur
  //
  sampleMode: 'always',
