...
module.exports = function (mysql) {
  var Query = requirePatch.relativeRequire('mysql/lib/protocol/sequences/Query')
  var Connection = requirePatch.relativeRequire('mysql/lib/Connection')
  var Pool = requirePatch.relativeRequire('mysql/lib/Pool')
