...
function v3 (express) {
  shimmer.wrap(express.Router.prototype, 'route', function (fn) {
    return function (method) {
      ...
      route.callbacks = route.callbacks.map(function (func) {
        return function (req, res, next) {
          ...
          var done = once(tv.requestStore.bind(function () {
            layer.exit()
          }))
...
function v4 (express) {
  methods.concat('all').forEach(function (method) {
    if (typeof express.Route.prototype[method] === 'undefined') {
      return
    }
  ...
  if ( ! View._tv_express_patched) {
    ...
    shimmer.wrap(View.prototype, 'render', function (render) {
      return function (options, callback) {
        ...
        // Run renderer
        return last.descend('render', data).run(function (wrap) {
