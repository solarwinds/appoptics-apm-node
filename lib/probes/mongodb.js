 ...
 * o drop_index
 * o drop_indexes
 * o ensure_index (No such query, compound of index_information and create_index)
 * o find
 * o find_and_modify
 * o group
 * o index_information
 ...
 * o remove
 * o rename
 * o save (No such query, compound of insert and update)
...
module.exports = function (mongodb) {
  ...
  var save = mongodb.Collection.prototype.save
  mongodb.Collection.prototype.save = function (doc, options, callback) {
  ...
  var ensureIndex = mongodb.Db.prototype.ensureIndex
  mongodb.Db.prototype.ensureIndex = function (collectionName, fieldOrSpec, options, callback) {
    if (typeof options === 'function') {
      callback = options
      options = {}
    }
    var run = ensureIndex.bind(this, collectionName, fieldOrSpec, options)
    var last = Layer.last
