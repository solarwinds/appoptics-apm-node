...
module.exports = function (cassandra) {
  var pkg = requirePatch.relativeRequire('cassandra-driver/package.json')
  ...
  patchRequestHandler(RequestHandler.prototype, pkg.version)
  patchClient(cassandra.Client.prototype, pkg.version, consistencies)

  return cassandra
}

function patchRequestHandler (requestHandler, version) {
