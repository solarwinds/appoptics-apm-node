...
function patchClient (module, protocol) {
  ...
  // wrap get if at least node 8. there are a few versions
  // of node 8 where https does not need get to be wrapped
  // but most users will be on a more recent version.
