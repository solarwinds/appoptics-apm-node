...
function patchConnection (conn) {
  function findViews (ctx) {
    return this._views ? this._views : (
      this.pack && this.pack._env.views ? this.pack._env.views : (
        this._server && this._server._env.views
      )
    )
  }
  ...
  function runAndPatchView (fn) {
    return function () {
      var ret = fn.apply(this, arguments)
      var views = findViews(this)
      if (views) {
        patchView(views.constructor.prototype)
      }
      return ret
    }
  }
