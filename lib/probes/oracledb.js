...
const tv = require('..')
const conf = tv.oracledb
const {Sanitizer} = tv.addon
...
function patchRelease (conn) {
  ...
  shimmer.wrap(conn, 'release', fn => function (cb) {
    return fn.call(this, tv.bind(cb))
  })
}
