...
if (uc.unusedProbes.length) {
  log.warn(`config file probes not recognized: ${uc.unusedProbes.jooin(', ')}`);
}
...
if (enabled) {
  ...
  // perform a little sleight of hand to keep testing working across
  // oboe versions.
  // TODO BAM remove when old oboe is no longer a consideration.
