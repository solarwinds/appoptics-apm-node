...
exports.specialUrls = config.specialUrls
...
if (!enabled) {
  ...
  exports.startOrContinueTrace = function (xtrace, build, run, opts, cb) {
    ...
    let settings
    try {
      settings = exports.getTraceSettings(maker.name, xtrace)
    ...
    const runFunction = (settings.sample ? runRootSampled : runRootUnsampled)
