...
//
// now the logging facility is setup so start the notification service and
// do tasks that might generate a log message.
//
if (!process.env.AO_TEST_NO_NOTIFICATIONS) {
