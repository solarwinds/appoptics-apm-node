...
//
var traceMode, sampleRate, sampleSource, host, port, accessKey, rumId
...
Object.defineProperty(exports, 'accessKey', {
  ...
  set: function (value) {
    ...
    // Generate SHA1 hash of accessKey
    var shasum = crypto.createHash('sha1')
    shasum.update('RUM' + value)
    var hash = shasum.digest('hex')

    // Convert to base64
    rumId = new Buffer(hash).toString('base64')
  }
})
