...
/**
 * Check whether ready to sample
 *
 * @param {Number} ms - milliseconds to wait; default 0 means don't wait.
...
/**
 * Set a custom transaction name function for a specific probe.
 *
 * This is commonly used when setting custom names for all or most routes.
 *
 * @method setCustomTxNameFunction
 * @param {String} probe The probe to set the function for
 * @param {Function} fn A function to set or falsey value to clear. If a
 *                      function it should a string name or falsey value to use
 *                      the default. The calling signature of the function varies
 *                      by probe.
 */
 ...
 *
 */
exports.SetCustomTxName = function (req, res, name) {
  // TODO BAM validate res object
