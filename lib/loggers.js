...
//
exports.error = debug('appoptics:error')        // used for what appear to be real errors
exports.force.error = exports.error
exports.info = debug('appoptics:info'),         // used for unexpected occurrences
exports.force.info = exports.info
