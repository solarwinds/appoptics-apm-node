...
const initial = 'APPOPTICS_LOG_SETTINGS' in process.env ? process.env.APPOPTICS_LOG_SETTINGS : 'error,warn'
const opts = {
  defaultLevels: initial,
  envName: 'APPOPTICS_LOG_SETTINGS'
}
const logger = new (require('./debug-custom'))('appoptics', opts)
