...
function definePropertiesOn (ao) {
  ...
  if (process.env.AO_DEBUG_CONTEXT) {
    Object.assign(clsOpts, {debug:
      {showContext: process.env.AO_DEBUG_CONTEXT, showActive: false}
    });
  }

  Object.defineProperty(ao, 'requestStore', {
    get () {
      return cls.getNamespace(contextName) || cls.createNamespace(contextName, clsOpts);
    }
  });
