 ...
 *
 */
function automaticLambdaHandler (event, context, callback) {
  return Promise.resolve({statusCode: 203, body: JSON.stringify({result: 'i am the japanese sandman'})});
}
