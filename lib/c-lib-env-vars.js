...
// for each env var 'APPOPTICS_${name}':
// {name, type: [s]tring, [i]nteger, [b]oolean, or object} where object
// is a map of option values to internal value, e.g. {enable: 1, disable: 0}
const keyMap = {
